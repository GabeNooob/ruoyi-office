...
public interface EmployeeEntryBillMapper extends BaseMapperX<EmployeeEntryBillDO> {
    ...
    default PageResult<EmployeeEntryBillDO> selectPage(EmployeeEntryBillPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<EmployeeEntryBillDO>()
                ...
                .eqIfPresent(EmployeeEntryBillDO::getDeptId, reqVO.getDeptId())
                .likeIfPresent(EmployeeEntryBillDO::getDeptName, reqVO.getDeptName())
                .eqIfPresent(EmployeeEntryBillDO::getCompanyId, reqVO.getCompanyId())
                .likeIfPresent(EmployeeEntryBillDO::getCompanyName, reqVO.getCompanyName())
